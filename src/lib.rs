// src/lib.rs
/*
 * Core library for GsapAnimation
 */
...
#[derive(Debug)]
pub struct GsapAnimationProcessor {
    verbose: bool,
    processed_count: usize,
}

impl GsapAnimationProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting GsapAnimation processing");
    
    let mut processor = GsapAnimationProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = GsapAnimationProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = GsapAnimationProcessor::new(false);
